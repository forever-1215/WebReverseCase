...
headers_params = execjs.compile(open('./demo.js', 'r',encoding='utf-8').read()).call('get_header_params', _timestamp)
...
data_params = execjs.compile(open('./demo.js', 'r',encoding='utf-8').read()).call('get_data_params', data1,data2, _timestamp)
...
mingwen = execjs.compile(open('./demo.js', 'r',encoding='utf-8').read()).call('decrypt',response.json())
